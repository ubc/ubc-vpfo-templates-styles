...
if ( $is_grandchild ) {
	...
	$parent_siblings = get_pages( array(
		...
		<div class="sidenav-menu">
			...
			foreach ( $parent_siblings as $parent_sibling ) {
				...
				if ( $this_page_parent) {
					...
					<div class="accordion" data-open-default="true">
						<div class="ac">
							<div class="ac-header d-flex align-items-center justify-content-between">
								<a href="<?php echo esc_url( get_permalink( $parent_sibling_id ) ); ?>" rel="bookmark" title="<?php echo get_the_title( $parent_sibling_id ); ?>">
									<?php echo get_the_title( $parent_sibling_id ); ?>
								</a>
								...
								<div class="ac-panel">
									<ul>
										...
										foreach ( $siblings as $sibling ) {
											...
											?>
											<li
											<?php if ( $this_page ) { echo ' class="active-page"'; } ?>
											>
					...
					$parent_sibling_children = get_pages( array(
	...
	if ($has_siblings) {
		...
		<div class="sidenav-menu">
			...
			foreach ( $siblings as $sibling ) {
				...
				$sibling_children = get_pages( array(
					'child_of' => $sibling_id,
					'parent' => $sibling_id,
					'sort_column' => 'menu_order',
				) );
				...
				if ( $has_sibling_children ) {
					?>
					<div class="accordion"
					<?php if ($this_page) { echo ' data-open-default="true"'; } ?>
					>
						<div class="ac">
							<div class="ac-header d-flex align-items-center justify-content-between<?php if ( $this_page ) { echo ' active-page'; } ?>">
								<a href="<?php echo esc_url( get_the_permalink( $sibling_id ) ); ?>" rel="bookmark" title="<?php echo get_the_title( $sibling_id ); ?>">
							...
							<div class="ac-panel">
								<ul>
									...
									foreach ( $sibling_children as $sibling_child ) {
										...
										?>
										<li>
											<a href="<?php echo esc_url( get_the_permalink( $sibling_child_id ) ); ?>" rel="bookmark" title="<?php echo get_the_title( $sibling_child_id ); ?>">
												<?php echo get_the_title( $sibling_child_id ); ?>
											</a>
										</li>
										<?php
									}
					...
					?>
					<div class="no-accordion<?php if ( $this_page ) { echo ' active-page'; } ?>">
